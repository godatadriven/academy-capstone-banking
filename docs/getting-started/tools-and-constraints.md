...
| **Power BI** | The final stakeholder-facing dashboard - see [Build the Power BI Dashboard](../project-guide/12-power-bi-dashboard.md). |
| **Git / version control** | Conceptual version control of your work - see [Consider Production Readiness](../project-guide/09-production-readiness.md). |
| **GenAI tools** | Where justified - see [Assess GenAI](../project-guide/10-assess-genai.md). Not mandatory. |

You are expected to **justify** tool choices where it isn't obvious - see [Explore the Data](../project-guide/05-explore-the-data.md) for the specific requirement to explain when you used Python vs. SQL.
