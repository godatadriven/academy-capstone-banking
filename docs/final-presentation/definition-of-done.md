...
## Done vs. not done - a quick gut check

| Signal you're done | Signal you're not done yet |
|---|---|
| Every team member can answer all 8 questions above, specifically, for your project | Answers rely on "I think someone else covered that" |
