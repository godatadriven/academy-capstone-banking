...
- [ ] Power BI dashboard completed - [Build the Power BI Dashboard](project-guide/12-power-bi-dashboard.md)
- [ ] Storyboard completed - [Build the Story](project-guide/13-build-the-story.md)
- [ ] Pyramid structure applied - [Build the Story](project-guide/13-build-the-story.md)
- [ ] Technical/non-technical audience considered - [Build the Story](project-guide/13-build-the-story.md)
- [ ] Recommendation is clear - [Build the Story](project-guide/13-build-the-story.md)
- [ ] Stakeholder ask is clear - [Build the Story](project-guide/13-build-the-story.md)
- [ ] Next steps are clear - [Build the Story](project-guide/13-build-the-story.md)

## Final submission

- [ ] All required artefacts included - [Required Deliverables](deliverables/required-deliverables.md)
- [ ] README completed - [Technical Documentation](deliverables/technical-documentation.md)
- [ ] Assumptions documented - [Technical Documentation](deliverables/technical-documentation.md)
